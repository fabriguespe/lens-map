...
<br />
<br />**[Lensfrens](https://www.lensfrens.xyz/)**<br />Simple curated page for your lens profiles.<br /><br />
...
<br />
<br />**[AaveFeeCollectModule](https://github.com/lens-protocol/modules/blob/master/contracts/collect/AaveFeeCollectModule.sol)**<br />Extend the LimitedFeeCollectModule to deposit all received fees into the Aave Polygon Market (if applicable for the asset) and send the resulting aTokens to the beneficiary.<br /><br />
**[AuctionCollectModule](https://github.com/lens-protocol/modules/blob/master/contracts/collect/AuctionCollectModule.sol)**<br />This module works by creating an English auction for the underlying publication. After the auction ends, only the auction winner is allowed to collect the publication.<br /><br />
...
**[TeaParty](https://app.teaparty.life/)**<br />TeaParty empower creators to reach a larger audience and boost discoverability, while rewarding people for engaging with meaningful content<br /><br />
**[TokenGatedReferenceModule](https://github.com/lens-protocol/modules/blob/master/contracts/reference/TokenGatedReferenceModule.sol)**<br />A reference module that validates that the user who tries to reference has a required minimum balance of ERC20/ERC721 token.<br /><br />
...
**[LensTags](https://drive.google.com/file/d/1eX2KSgwNsuiY16a6eAN_iZcHbgn45KH1/view)**<br />LensTags is a Web3 Social Graph focused on collective-knowledge, content discovery and personal organization using Tags.<br /><br />
## Community Tool 👫
...
<br />
<br />**[CultivatorDAO](https://mirror.xyz/lensprotocol.eth/pIzwjs9uhH8eSS1Bx0K1r-3iHEgLlBt6ruPXcEJe0S0)**<br />A new era for open, decentralized content moderation in Web3.<br /><br />
**[Focalize](https://ethglobal.com/showcase/focalize-9vo88)**<br />Browser extension that allows you to quickly share to Lens Protocol.<br /><br />
**[Freelansers](https://ethglobal.com/showcase/freelensers-3v207)**<br />Freelance in Web3 done the safest way. Find work opportunities through the Lens social media platform. Safe and secure for both parties.<br /><br />
**[Greenhouse](https://greenhouse.social/)**<br />Grow and spread your web3 roots<br /><br />
**[Handle Claim](https://claim.lens.xyz/)**<br />Claim your handle<br /><br />
...
**[Superfun](https://lens.superfun.social/)**<br />A social app for Meme artists to get rewarded for their super fun content.<br /><br />
**[YUP](https://app.yup.io/)**<br />Web3 Social Network<br /><br />
## Analytics 📊
Analytics is important for maintaining ecosystem transparency, protocol health, and ongoing growth metrics. Data provides truth to an increasingly complex world.
<br />
<br />**[Dune](https://dune.com/gm365/lens)**<br />Lens and Lenster dashboard in Lens<br /><br />
**[Dune:Lens Protocol Overview](https://dune.com/rustamov/overview)**<br />Lens Protocol Overview<br /><br />
**[Dune:niftytable](https://dune.com/niftytable/Lens)**<br />Dune analytics Lens dashboard by oxCofi<br /><br />
...
**[Lens Revenues](https://dune.com/zoma/lens-revenue)**<br />A Dune dashboard with the revenue by Lens user<br /><br />
...
<br />
<br />**[InLens](https://inlens.xyz/)**<br />Find your friends from Twitter in Lens Protocol. Create shareable lists.<br /><br />
...
<br />
<br />**[API Examples](https://github.com/lens-protocol/api-examples)**<br />API Examples Repo<br /><br />
**[Developer Quickstart](https://docs.lens.xyz/docs/developer-quickstart)**<br />NextJs starter kit<br /><br />
**[Docs](https://docs.lens.xyz/docs)**<br />Official Lens API documentation<br /><br />
...
**[Use lens](https://github.com/use-lens/use-lens)**<br />undefined<br /><br />
## Identity 🎭
Every profile has an owner and with that, we are building up an on-chain identity for these profiles. This allows you to do powerful things like knowing if that profile has a human behind it, showing the ens name, and a lot more.
<br />
...
**[Verify Me!](https://ethglobal.com/showcase/verify-me-gcmnb)**<br />VerifyMe! democratizes the verification check mark on social media via POAP’s on Lens<br /><br />
## Music 🎶
...
<br />
<br />**[Beets](https://wavwrld.com)**<br />Building infrastructure to enable unique musical experiences that connect artist with their true fans<br /><br />
**[ClubSpace](https://ethglobal.com/showcase/clubspace-cwzqx)**<br />ClubSpace is a live listening party for creators to share their curated music NFTs with their Lens frens<br /><br />
...
<br />
<br />**[Welook](https://welook.io/)**<br />Create your own POAPs, and share them with the world. Discover new wallets and POAPs.<br /><br />
## Algorithms 🧮
...
<br />
<br />**[LensScore](https://devpost.com/software/lensscore-for-defi-lending-and-web3-interactions)**<br />LensScore is a protocol to calculate users' score based on metrics from Lens profiles and provide it to all EVM-compatible chains using RedStone Oracle.<br /><br />
...
<br />
<br />**[Alps Finance](https://app.alps.finance/)**<br />Alps Finance is a Social DeFi investing platform for DeFi investors to build their own investing community and reputation easily. <br /><br />
...
**[Harfang](https://harfang.app)**<br />Postal NFT creator and marketplace<br /><br />
**[LensAI](https://thegallerydao.vercel.app/login)**<br />Text2Image NFT generator where you can monetize your beautiful AI creations<br /><br />
**[Lenscast](https://www.raycast.com/peduarte/lenscast)**<br />Web3 Social Raycast Extension built with Lens Protocol<br /><br />
**[LensEncrypted Messaging](https://lens-encrypted-messaging.netlify.app/)**<br />A tool to encrypt and send message<br /><br />
**[Mad.Finance](https://madfinance.xyz/)**<br />Thge ad protocol for web3, paying content creators in real-time <br /><br />
**[Soclly](https://www.soclly.com)**<br />Shape your Web3 dreams into reality by interacting with Web3 Gurus<br /><br />
## Resource 📖
...
**[Lens Website](https://lens.xyz)**<br />Lens Protocol Official Website<br /><br />
**[lens-map](https://github.com/fabriguespe/lens-map)**<br />Lens Map Notion Repo<br /><br />
**[Lensverse](https://www.notion.so/aave/Lensverse-a5926eab1d8148eda10053af9f4e28a0)**<br />Lens Application Ecosystem<br /><br />
